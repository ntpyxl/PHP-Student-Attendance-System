<h1 class="text-xl font-semibold text-center">Students' Excuse Letters</h1>
<hr class="py-1">
...
<div>
    ...
    $allStudentAttendanceData = $admin->viewExcusesByCourse();
    ?>

    <div class="flex flex-row space-x-3">
        <div class="flex flex-col flex-1">
            <label for="excuse_studentYearLevelField" class="ml-1">Year Level</label>
            <select
                id="excuse_studentYearLevelField"
                type="text"
        ...
        <div class="flex flex-col flex-3">
            <label for="excuse_studentCourseField" class="ml-1">Course</label>
            <select
                id="excuse_studentCourseField"
                type="text"
                class="border-2 px-2 py-1 border-black rounded-2xl">
    ...
    <table class="mt-3">
        ...
        <tbody id="allStudentExcuseLetterRows">
        </tbody>
    </table>
</div>

<script>
    document.addEventListener("DOMContentLoaded", () => refreshExcuseLettersAdminList());
</script>